            ...
            <section class="centro">
                ...
                <div class="telacadastro">
                    ...
                    <form class="form f-cadastro <?=Yii::$app->session->hasFlash('sucesso') ? 'hide' : ''?>" id="contato-form" action="<?=Yii::$app->params['pathUrlWeb'] . ltrim($_SERVER['REQUEST_URI'], '/')?>" method="post">
                        ...
                        <label class="effectp5">
                            <input type="text" name="Contato[telefone]" placeholder="Telefone" class="box effectp5" value="<?=isset($dados['telefone']) ? $dados['telefone'] : ''?>" data-validation-engine="validate[required]" data-mask="(99) 9999-99999" data-mask2="(99) 99999-9999" />
                        </label>
                        <label class="effectp5">
