...
<tr>
	<td width="600" align="center" style="background-color:#0095da;text-align:left;padding:20px 60px;font-family:verdana;font-size:16px;color:#fff;">
		...
		<tr>
			<td align="center"><strong>Olá, <?=$dados->nome?></strong></td>
		</tr>
		</table>
		...
		<tr>
			...
			<td align="left" style="padding:10px 20px;border-radius:50px;font-size:14px;background-color:#fff;color:#777;"><?=$dados->nome?></td>
		</tr>
		<tr>
			...
			<td align="left" style="padding:10px 20px;border-radius:50px;font-size:14px;background-color:#fff;color:#777;"><?=$dados->email?></td>
		</tr>
		<tr>
			...
			<td align="left" style="padding:10px 20px;border-radius:50px;font-size:14px;background-color:#fff;color:#777;"><?=$dados->telefone?></td>
		</tr>
		<tr>
			...
			<td align="left" style="padding:10px 20px;border-radius:50px;font-size:14px;background-color:#fff;color:#777;"><?=$dados->cidade?></td>
		</tr>
		<tr>
			...
			<td align="left" style="padding:10px 20px;border-radius:50px;font-size:14px;background-color:#fff;color:#777;"><?=$dados->sigla?></td>
		</tr>
		<tr>
			<td colspan="2" align="left" style="padding:10px 20px;border-radius:50px;font-size:14px;background-color:#fff;color:#777;"><?=$dados->mensagem?></td>
		</tr>
		</table>
		...
		<tr>
			<td align="center">
				Agredecemos sua mensagem.<br><br>
				Atenciosamente,<br>
